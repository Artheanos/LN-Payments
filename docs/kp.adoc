[.text-center]
image:images/pjatk_logo.png[image]
...
4+| *_Rezultaty projektu (oczekiwane produkty lub usługi):_* Serwer do przyjmowania płatności wraz z aplikacją webową oraz apkikacja mobilna do podpisywania tranzakcji z portfela.
