...
stronie serwera osiągnęła limit określony w ustawieniach serwera. Jeżeli limit zostanie przekroczony, to nastąpi
...
zamknięcia kanałów, zarówno kooperacyjnie, jak i siłowo.
