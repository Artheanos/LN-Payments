...
serwerze, co 15 minut będzie uruchamiane zaplanowane zadanie, którego celem będzie zamykanie kanałów.
Standardowo kanały będą zamykane kooperacyjnie. Dany kanał zostanie zamknięty siłowo, jeśli będzie nieaktywny
dłużej niż tydzień. Dodatkowo administrator serwera będzie miał możliwość ręcznego zamknięcia
kanałów, zarówno kooperacyjnie, jak i siłowo.
...
rozpropagowana w sieci Bitcoin. Podczas oczekiwania na podpisy, którego zadanie celem jest przelewanie środków pomiędzy
portfelami, nie będzie działać.
