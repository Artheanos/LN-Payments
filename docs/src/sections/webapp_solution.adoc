...
że token jest w trakcie ładowania. Powiadomienie widoczne jest na rysunku 66.
...
Ekran portfela zaprezentowany został na rysunku 69.
...
Efekt można zobaczyć na rysunku 70.
