...
Jest to główna część systemy, w której użytkownicy, zarówno zalogowani, jak i niezalogowani, będą mogli kupować tokeny
...
Jeżeli zostanie on dodany do tworzonego portfela, administrator będzie mógł podpisywać transakcje za pomocą swojego
klucza prywatnego bądź je odrzucać.
