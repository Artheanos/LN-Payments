...
jeden katalog, w którym znajduje się kod źródłowy aplikacji. Pokazany jest na rysunku 40.
...
standardowym układem dla programu Maven<<maven_directories>>. Jego zawartość zaprezentowana jest na rysunku 41.
