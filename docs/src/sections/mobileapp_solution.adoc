...
nowego powiadomienia push. Dla przykładu w kodzie 125 zaprezentowano zawartość pliku _colors.ts_.
...
odpowiedź HTTP. Kod metody _request_ zaprezentowano w kodzie 131.
...
użytkownik wypełni formularz i go wyśle, zostanie wywołana metoda _onSubmit_, widoczna w kodzie 142.
