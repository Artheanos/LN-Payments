...
wspierana jest jedynie zmiana hasła. Api widoczne jest na rysunku 47.
...
Nigdy nie było planów na dodanie funkcjonalności pozwalającej na pobranie danych innych użytkowników.
