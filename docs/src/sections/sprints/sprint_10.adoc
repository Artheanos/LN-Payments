...
W oryginalnym planie na tą iterację planowano przygotowania do wydania aplikacji, natomiast w rzeczywistości wysiłki zespołu skupiły się głównie na aplikacji mobilnej, ponieważ chciano zakończyć nad nią prace przed terminem jej prezentacji na przedmiocie _PAMO_. Zaplanowano również zajęcie się zadaniami związanymi z rozwojem książki do projektu dyplomowego oraz długiem technicznym.
