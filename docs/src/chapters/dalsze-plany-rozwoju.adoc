...
wkładem władnym członków zespołu projektowego. W rejestrze zadań znajduje się jeszcze kilkanaście zadań. Większość
z nich dotyczy zmniejszenia długu technicznego oraz mniej znaczących poprawek. Znalazło się tam również ważne
...
płatności, wykorzystując stworzone rozwiązanie tylko i wyłącznie jaki bramki płatności. Prawdopodobnie dodanie tej
...
aplikacji internetowej w aplikacji mobilnej, takich jak podgląd środków w portfelu czy też przeglądania historii
