...
może samodzielnie dysponować środkami. Musi to być zawsze decyzja kolektywna. Dodatkowym
...
prawdopodobieństwo utraty środków w niekontrolowany sposób jest prawie zerowe.
