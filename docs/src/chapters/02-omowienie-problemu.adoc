...
minut, a jest on w stanie pomieścić maksymalnie kilka tysięcy transakcji. Spowodowało to, że opłaty transakcyjne są
bardzo wysokie. W lutym 2022 jest to około $2, natomiast w kwietniu 2021 opłaty osiągnęły wartość $60. Wysokie opłaty
