...
o krokach potrzebnych do zbudowania projektu, jest _makefile_. Jego zawartość pokazana jest w kodzie 155.
...
z całością dokumentacji. Przykładowy diagram zaprezentowano w kodzie 157.
