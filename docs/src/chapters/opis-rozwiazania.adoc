...
include::../sections/solution/webapp.adoc[]
...
Ostatnim folderem w repozytorium projektu jest _devtools_. Zawiera on dodatkowe pliki związane z programami
...
systemu, czyli węzeł sieci Lightning, węzeł sieci Bitcoin oraz bazę danych. Dostępne są trzy pliki _docker-compose_.
