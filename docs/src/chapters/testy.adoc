...
Napisanych zostało 333 testy, które rozlokowano w 61 plikach.

.Raport z pokrycia testami kodu części backendowej
image::../images/tests_chapter/test_coverage_backend.png[]

Zamieszczony raport pochodzi z pliku _jacoco.exec_. Wygenerowany został on przez _Jacoco_ do pliku _index.html_ i
