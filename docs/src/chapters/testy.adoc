...
ekranu z rysunku 113. Jak sama nazwa wskazuje, znajdują się tam testy związane z administratorami np. sprawdzanie, czy ich tworzenie
działa prawidłowo.
...
Stworzonych zostało 13 plików zawierających 39 testów, co jest przeciętnym wynikiem.
