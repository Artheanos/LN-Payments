...
kanałach i portfelu Lightning, aby samemu uruchamiać transfery środków. Postęp do uruchomieniu transferów można obserwować na kafelkach w górnej części panelu. Prezentowany zrzut ekranu jest z portfela działającego już jakiś czas,
